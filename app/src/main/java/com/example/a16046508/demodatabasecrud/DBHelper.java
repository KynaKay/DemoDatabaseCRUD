...
public class DBHelper extends SQLiteOpenHelper {
    ...
    private static final String COLUMN_MODULE = "module_name";
    ...
    public long insertNote(String noteContent) {
        ...
        long result = db.insert(TABLE_NOTE, null, values); // row id of the record
        db.close();
    ...
    public ArrayList<Note> getAllNotes(String keyword) {
        ...
        Cursor cursor = db.query(TABLE_NOTE, columns, condition, args,
                null, null, null, null); // structured query
    ...
    public int deleteNote(int id){
        SQLiteDatabase db = this.getWritableDatabase();
        String condition = COLUMN_ID + "= ?"; // '?' replacement // a place holder
